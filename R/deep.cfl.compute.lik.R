deepgmm_cfl_compute.lik <- function(y, numobs, k, xi.list, A.list, D.list, omega.list, w.list) {
  ...
  for (i in 1 : tot.k)  {
    ...
    if (length(k)==1){
      mu.tot <- A.list[[1]]  %*% xi.list[[1]][, k.comb[i, 1]]
      
      var.tot <- A.list[[1]] %*% omega.list[[1]][,,k.comb[i, 1] ] %*%
                                    t(A.list[[1]]) +
                                    D.list[[1]][,,k.comb[i, 1]]
    ...
    if (length(k)==2){
      mu.tot <- A.list[[1]]  %*% A.list[[2]]  %*% xi.list[[2]][, k.comb[i, 2]]

      var.tot <- A.list[[1]] %*% (A.list[[2]] %*% omega.list[[2]][,,k.comb[i, 2] ] %*%
                                                     t(A.list[[2]]) +
                                                     D.list[[2]][,,k.comb[i, 2]]) %*% t(A.list[[1]]) + D.list[[1]][,,k.comb[i,1]]
    ...
    if (length(k)==3){
      mu.tot <- A.list[[1]]  %*% A.list[[2]]  %*% A.list[[3]]  %*% xi.list[[3]][, k.comb[i, 3]]
      
      var.tot <- A.list[[1]]  %*% (A.list[[2]] %*% (A.list[[3]] %*% omega.list[[3]][,,k.comb[i, 3] ] %*%
                                                     t(A.list[[3]]) +
                                                     D.list[[3]][,,k.comb[i, 3]])  %*% t(A.list[[2]]) + D.list[[2]][,,k.comb[i,2]] ) %*% t(A.list[[1]]) + D.list[[1]][,,k.comb[i,1]]
    ...
    if (length(k)==4){
      mu.tot <- A.list[[1]]  %*% A.list[[2]]  %*% A.list[[3]]  %*% A.list[[4]]  %*% xi.list[[4]][, k.comb[i, 4]]
      
      var.tot <- A.list[[1]]  %*% ( A.list[[2]]  %*% (A.list[[3]] %*% (A.list[[4]] %*% omega.list[[4]][,,k.comb[i, 4] ] %*%
                                                      t(A.list[[4]]) +
                                                      D.list[[4]][,,k.comb[i, 4]])  %*% t(A.list[[3]]) + D.list[[3]][,,k.comb[i,3]] ) %*% t(A.list[[2]]) + D.list[[2]][,,k.comb[i,2]] ) %*% t(A.list[[1]]) + D.list[[1]][,,k.comb[i,1]]
