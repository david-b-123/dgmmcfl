deepgmm_cfl_sem.alg.4 <- function(y, numobs, p, r, k, A.list, D.list,
  ...
  while ((hh < it) & (ratio > eps )) {
    ...
    for (p1 in 1 : k[l]) {
      for (p2 in 1 : k[l + 1]) {
        for (p3 in 1 : k[l + 2]) {
          for (p4 in 1 : k[l + 3]) {
            sigma.tilde.inv <- ginv(A.list[[l+1]] %*% (ginv(A.list[[l+2]] %*% (
              A.list[[l+3]] %*% omega.list[[l+3]][,,p4]  %*% t(A.list[[l+3]]) + D.list[[l+3]][,,p4]
            ) %*% t(A.list[[l+2]])) )%*% t(A.list[[l+1]]))
            
            A <- sigma.tilde.inv + t(A.list[[l]]) %*%
              (ginv(D.list[[l]][,, p1])) %*% (A.list[[l]])
            
            mu.tilde  <- c(A.list[[l+1]] %*% A.list[[l+2]] %*% A.list[[l+3]] %*% xi.list[[l+3]][,p4])
    ...
    for (p1 in 1 : k[l]) {
      for (p2 in 1:k[l+1])  {
        for (p3 in 1:k[l+2])  {
          sigma.tilde.inv <- ginv(A.list[[l+1]] %*% (
            A.list[[l+2]] %*% omega.list[[l+2]][,,p3]  %*% t(A.list[[l+2]]) + D.list[[l+2]][,,p3]
          ) %*% t(A.list[[l+1]]))
          
          A <- sigma.tilde.inv + t(A.list[[l]]) %*%
            (ginv(D.list[[l]][,, p1])) %*% (A.list[[l]])
          
          mu.tilde  <- c(A.list[[l+1]] %*% A.list[[l+2]] %*% xi.list[[l+2]][,p3])
