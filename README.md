...
It compares well on small datasets, although it still remains untested for larger datasets. I have run it on a few public single-cell datasets, and so, this could be useful as a complementary tool.
